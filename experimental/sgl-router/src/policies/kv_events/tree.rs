...
//! integer-keyed maps (`children`, `by_hash`, `nodes` — trusted block
//! hashes and node ids) use [`FxHashMap`] / [`FxHashSet`]; SipHash's DoS
//! resistance is pure overhead on them. Worker-keyed maps keep std.
//!
